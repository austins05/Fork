...
#ifndef COCOAMQTTWEBSOCKET_SWIFT_H
#define COCOAMQTTWEBSOCKET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CocoaMQTTWebSocket",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtCC18CocoaMQTTWebSocket18CocoaMQTTWebSocket20FoundationConnection")
...
@interface FoundationConnection (SWIFT_EXTENSION(CocoaMQTTWebSocket)) <NSURLSessionWebSocketDelegate>
